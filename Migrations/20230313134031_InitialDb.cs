...
namespace lagalt_web_api.Migrations
{
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projects_Contributors_ContributorId",
            ...
            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "Id", "AdminId", "Category", "ContributorId", "Description", "GitURL", "Name", "Progress" },
                values: new object[,]
                {
                    { 1, null, 3, null, "Joachim Rønning", "https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/C6AB0EDCE8F41882EBBB782B76DD4F05D7E360D7C3F23B4F6D02C24699B26105/scale?width=1200&aspectRatio=1.78&format=jpeg", "Tinder v2", 0 },
                    { 2, null, 3, null, "Looking for a c# back-end developer", "https://gitlab.com/Frechr/assignment-three/-/tree/master/", "EF_CodeFirst", 0 },
                    { 3, null, 3, null, "Web app to catch pokemons!", "https://gitlab.com/JarandNL/angular_pokemontrainer", "Exciting_Angular_Project", 1 },
                    { 4, null, 1, null, "Hot youth!!!!", "https://www.imdb.com/title/tt0475293/", "High School Musical", 3 },
                    { 5, null, 0, null, "Pls help make the best song ever", null, "Best song ever!!!", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, "OleDole@mail.no", "Ole", "Dole", null, true, "hulken" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_ContributorId",
                table: "Projects",
